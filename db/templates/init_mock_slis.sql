...
(1001, 5001, 'ΔΟΚΙΜΑΣΤΙΚΟΣ', 'ΑΣΘΕΝΗΣ 01', 22140, 'ΑΞΟΝΙΚΗ ΤΟΜΟΓΡΑΦΙΑ ΘΩΡΑΚΑ', 'CT', '2026-08-10', 1, 'Κηφισιά', 'DOC104', 'ΔΡ. ΠΑΡΑΠΕΜΠΩΝ Δ', NULL, NULL, NULL, NULL),

-- 2. Unassigned CT Abdomen (Order 5001 — Part 2: Shared Order ID demo)
(1003, 5001, 'ΔΟΚΙΜΑΣΤΙΚΟΣ', 'ΑΣΘΕΝΗΣ 01', 22141, 'ΑΞΟΝΙΚΗ ΤΟΜΟΓΡΑΦΙΑ ΚΟΙΛΙΑΣ', 'CT', '2026-08-10', 1, 'Κηφισιά', 'DOC104', 'ΔΡ. ΠΑΡΑΠΕΜΠΩΝ Δ', NULL, NULL, NULL, NULL),

-- 3. Unassigned MRI Brain (Order 5002 — Part 1)
(1002, 5002, 'ΔΟΚΙΜΑΣΤΙΚΟΣ', 'ΑΣΘΕΝΗΣ 02', 22150, 'ΜΑΓΝΗΤΙΚΗ ΤΟΜΟΓΡΑΦΙΑ ΕΓΚΕΦΑΛΟΥ', 'MRI', '2026-08-10', 2, 'Αμπελόκηποι', 'DOC104', 'ΔΡ. ΠΑΡΑΠΕΜΠΩΝ Δ', NULL, NULL, NULL, NULL),

-- 4. Unassigned MRI Spine (Order 5002 — Part 2: Shared Order ID demo)
(1008, 5002, 'ΔΟΚΙΜΑΣΤΙΚΟΣ', 'ΑΣΘΕΝΗΣ 02', 22151, 'ΜΑΓΝΗΤΙΚΗ ΤΟΜΟΓΡΑΦΙΑ ΣΠΟΝΔΥΛΙΚΗΣ ΣΤΗΛΗΣ', 'MRI', '2026-08-10', 2, 'Αμπελόκηποι', 'DOC102', 'ΔΡ. ΠΑΡΑΠΕΜΠΩΝ Β', NULL, 'ΠΡΟΤΙΜΗΣΗ: ΔΙΑΓΝΩΣΤΗΣ Γ', NULL, NULL),

-- 5. Exclusive Partnership Auto-Assignment (Doctor DOC101 -> Diagnostician 1 ΔΙΑΓΝΩΣΤΗΣ Α)
(1004, 5003, 'ΔΟΚΙΜΑΣΤΙΚΟΣ', 'ΑΣΘΕΝΗΣ 03', 22140, 'ΑΞΟΝΙΚΗ ΤΟΜΟΓΡΑΦΙΑ ΘΩΡΑΚΑ', 'CT', '2026-08-10', 1, 'Κηφισιά', 'DOC101', 'ΔΡ. ΠΑΡΑΠΕΜΠΩΝ Α', NULL, NULL, NULL, NULL),

-- 6. Dynamic Routing Rule Auto-Assignment (22705 Pamakristos -> Diagnostician 3 ΔΙΑΓΝΩΣΤΗΣ Γ)
(1005, 5004, 'ΔΟΚΙΜΑΣΤΙΚΟΣ', 'ΑΣΘΕΝΗΣ 04', 22705, 'ΜΑΓΝΗΤΙΚΗ ΦΑΣΜΑΤΟΣΚΟΠΙΑ (MRS)', 'MRI', '2026-08-10', 1, 'Κηφισιά', 'PAM01', 'ΠΑΜΜΑΚΑΡΙΣΤΟΣ', NULL, NULL, NULL, NULL),

-- 7. Pamakristos General On-Call Auto-Assignment (Ward Pamakristos)
(1006, 5005, 'ΔΟΚΙΜΑΣΤΙΚΟΣ', 'ΑΣΘΕΝΗΣ 05', 22140, 'ΑΞΟΝΙΚΗ ΤΟΜΟΓΡΑΦΙΑ ΘΩΡΑΚΑ', 'CT', '2026-08-10', 1, 'Κηφισιά', 'PAM01', 'ΠΑΜΜΑΚΑΡΙΣΤΟΣ', NULL, NULL, NULL, NULL),

-- 8. Constraint Comment Exclusion "ΟΧΙ ΔΙΑΓΝΩΣΤΗΣ Α" (Rule Engine Exclusion Demo)
(1007, 5006, 'ΔΟΚΙΜΑΣΤΙΚΟΣ', 'ΑΣΘΕΝΗΣ 06', 22150, 'ΜΑΓΝΗΤΙΚΗ ΤΟΜΟΓΡΑΦΙΑ ΕΓΚΕΦΑΛΟΥ', 'MRI', '2026-08-10', 1, 'Κηφισιά', 'DOC104', 'ΔΡ. ΠΑΡΑΠΕΜΠΩΝ Δ', NULL, 'ΠΡΟΣΟΧΗ: ΟΧΙ ΔΙΑΓΝΩΣΤΗΣ Α', NULL, NULL),

-- 9. General Clinical Comment WITHOUT Diagnostician Name (Standard comment display)
(1011, 5007, 'ΔΟΚΙΜΑΣΤΙΚΟΣ', 'ΑΣΘΕΝΗΣ 07', 22140, 'ΑΞΟΝΙΚΗ ΤΟΜΟΓΡΑΦΙΑ ΘΩΡΑΚΑ', 'CT', '2026-08-10', 1, 'Κηφισιά', 'DOC104', 'ΔΡ. ΠΑΡΑΠΕΜΠΩΝ Δ', NULL, 'ΠΡΟΣΟΧΗ: ΕΠΕΙΓΟΝ - ΑΣΘΕΝΗΣ ΜΕ ΣΚΙΑΓΡΑΦΙΚΟ IV', NULL, NULL),

-- 10. General Clinical Comment WITHOUT Diagnostician Name (Comparison note)
(1012, 5008, 'ΔΟΚΙΜΑΣΤΙΚΟΣ', 'ΑΣΘΕΝΗΣ 08', 22150, 'ΜΑΓΝΗΤΙΚΗ ΤΟΜΟΓΡΑΦΙΑ ΕΓΚΕΦΑΛΟΥ', 'MRI', '2026-08-10', 2, 'Αμπελόκηποι', 'DOC103', 'ΔΡ. ΠΑΡΑΠΕΜΠΩΝ Γ', NULL, 'ΣΥΓΚΡΙΣΗ ΜΕ ΠΡΟΗΓΟΥΜΕΝΗ ΕΞΕΤΑΣΗ ΑΠΟ 15/05/2026 - ΘΑ ΣΤΑΛΕΙ ΜΕ EMAIL', NULL, NULL),

-- 11. Patient History Match (oldpers=3 ΔΙΑΓΝΩΣΤΗΣ Γ — Skilled & Available)
(1013, 5009, 'ΔΟΚΙΜΑΣΤΙΚΟΣ', 'ΑΣΘΕΝΗΣ 09', 22150, 'ΜΑΓΝΗΤΙΚΗ ΤΟΜΟΓΡΑΦΙΑ ΕΓΚΕΦΑΛΟΥ', 'MRI', '2026-08-10', 2, 'Αμπελόκηποι', 'DOC104', 'ΔΡ. ΠΑΡΑΠΕΜΠΩΝ Δ', NULL, 'ΕΠΑΝΕΛΕΓΧΟΣ ΜΕΤΑ ΑΠΟ 6 ΜΗΝΕΣ', 3, 'ΔΙΑΓΝΩΣΤΗΣ Γ'),

-- 12. Patient History Match (oldpers=1 ΔΙΑΓΝΩΣΤΗΣ Α — Skilled & Available)
(1014, 5010, 'ΔΟΚΙΜΑΣΤΙΚΟΣ', 'ΑΣΘΕΝΗΣ 10', 22140, 'ΑΞΟΝΙΚΗ ΤΟΜΟΓΡΑΦΙΑ ΘΩΡΑΚΑ', 'CT', '2026-08-10', 1, 'Κηφισιά', 'DOC103', 'ΔΡ. ΠΑΡΑΠΕΜΠΩΝ Γ', NULL, 'ΕΠΑΝΕΛΕΓΧΟΣ CT ΘΩΡΑΚΑ', 1, 'ΔΙΑΓΝΩΣΤΗΣ Α'),

-- 13. Non-Exclusive Preferred Doctor Partnership (Doctor DOC102 -> Diagnostician 3 ΔΙΑΓΝΩΣΤΗΣ Γ)
(1015, 5011, 'ΔΟΚΙΜΑΣΤΙΚΟΣ', 'ΑΣΘΕΝΗΣ 11', 22150, 'ΜΑΓΝΗΤΙΚΗ ΤΟΜΟΓΡΑΦΙΑ ΕΓΚΕΦΑΛΟΥ', 'MRI', '2026-08-10', 2, 'Αμπελόκηποι', 'DOC102', 'ΔΡ. ΠΑΡΑΠΕΜΠΩΝ Β', NULL, NULL, NULL, NULL),

-- 14. Dynamic Lab Routing Rule (Lab 2 MRI Spine -> Diagnostician 5 ΔΙΑΓΝΩΣΤΗΣ Ε)
(1016, 5012, 'ΔΟΚΙΜΑΣΤΙΚΟΣ', 'ΑΣΘΕΝΗΣ 12', 22151, 'ΜΑΓΝΗΤΙΚΗ ΤΟΜΟΓΡΑΦΙΑ ΣΠΟΝΔΥΛΙΚΗΣ ΣΤΗΛΗΣ', 'MRI', '2026-08-10', 2, 'Αμπελόκηποι', 'DOC103', 'ΔΡ. ΠΑΡΑΠΕΜΠΩΝ Γ', NULL, NULL, NULL, NULL),

-- 15. Additional CT Abdomen
(1009, 5013, 'ΔΟΚΙΜΑΣΤΙΚΟΣ', 'ΑΣΘΕΝΗΣ 13', 22141, 'ΑΞΟΝΙΚΗ ΤΟΜΟΓΡΑΦΙΑ ΚΟΙΛΙΑΣ', 'CT', '2026-08-09', 1, 'Κηφισιά', 'DOC103', 'ΔΡ. ΠΑΡΑΠΕΜΠΩΝ Γ', NULL, NULL, NULL, NULL),

-- 16. Additional MRI Brain
(1010, 5014, 'ΔΟΚΙΜΑΣΤΙΚΟΣ', 'ΑΣΘΕΝΗΣ 14', 22150, 'ΜΑΓΝΗΤΙΚΗ ΤΟΜΟΓΡΑΦΙΑ ΕΓΚΕΦΑΛΟΥ', 'MRI', '2026-08-09', 2, 'Αμπελόκηποι', 'DOC104', 'ΔΡ. ΠΑΡΑΠΕΜΠΩΝ Δ', NULL, NULL, NULL, NULL),
