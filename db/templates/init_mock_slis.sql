...
(1001, 5001, 'ΜΑΡΙΑ', 'ΑΝΤΩΝΙΟΥ', 22140, 'ΑΞΟΝΙΚΗ ΤΟΜΟΓΡΑΦΙΑ ΘΩΡΑΚΑ', 'CT', '2026-08-03', 1, 'Κηφισιά', 'DOC104', 'ΔΡ. ΝΙΚΟΛΑΟΥ ΕΛΕΝΗ', NULL, NULL, NULL, NULL),

-- 2. Unassigned CT Abdomen (Order 5001 — Part 2: Shared Order ID demo)
(1003, 5001, 'ΜΑΡΙΑ', 'ΑΝΤΩΝΙΟΥ', 22141, 'ΑΞΟΝΙΚΗ ΤΟΜΟΓΡΑΦΙΑ ΚΟΙΛΙΑΣ', 'CT', '2026-08-03', 1, 'Κηφισιά', 'DOC104', 'ΔΡ. ΝΙΚΟΛΑΟΥ ΕΛΕΝΗ', NULL, NULL, NULL, NULL),

-- 3. Unassigned MRI Brain (Order 5002 — Part 1)
(1002, 5002, 'ΓΕΩΡΓΙΟΣ', 'ΚΩΝΣΤΑΝΤΙΝΟΥ', 22150, 'ΜΑΓΝΗΤΙΚΗ ΤΟΜΟΓΡΑΦΙΑ ΕΓΚΕΦΑΛΟΥ', 'MRI', '2026-08-03', 2, 'Αμπελόκηποι', 'DOC104', 'ΔΡ. ΝΙΚΟΛΑΟΥ ΕΛΕΝΗ', NULL, NULL, NULL, NULL),

-- 4. Unassigned MRI Spine (Order 5002 — Part 2: Shared Order ID demo)
(1008, 5002, 'ΓΕΩΡΓΙΟΣ', 'ΚΩΝΣΤΑΝΤΙΝΟΥ', 22151, 'ΜΑΓΝΗΤΙΚΗ ΤΟΜΟΓΡΑΦΙΑ ΣΠΟΝΔΥΛΙΚΗΣ ΣΤΗΛΗΣ', 'MRI', '2026-08-03', 2, 'Αμπελόκηποι', 'DOC102', 'ΔΡ. ΘΕΟΔΩΡΟΥ ΣΟΦΙΑ', NULL, 'ΠΡΟΤΙΜΗΣΗ: ΓΕΩΡΓΙΑΔΟΥ', NULL, NULL),

-- 5. Exclusive Partnership Auto-Assignment (Doctor DOC101 -> Diagnostician 1 Αλεξίου)
(1004, 5003, 'ΙΩΑΝΝΗΣ', 'ΝΙΚΟΛΑΟΥ', 22140, 'ΑΞΟΝΙΚΗ ΤΟΜΟΓΡΑΦΙΑ ΘΩΡΑΚΑ', 'CT', '2026-08-03', 1, 'Κηφισιά', 'DOC101', 'ΔΡ. ΚΩΝΣΤΑΝΤΙΝΟΥ ΜΙΧΑΗΛ', NULL, NULL, NULL, NULL),

-- 6. Dynamic Routing Rule Auto-Assignment (22705 Pamakristos -> Diagnostician 3 Γεωργιάδου)
(1005, 5004, 'ΕΛΕΝΗ', 'ΒΑΣΙΛΕΙΟΥ', 22705, 'ΜΑΓΝΗΤΙΚΗ ΦΑΣΜΑΤΟΣΚΟΠΙΑ (MRS)', 'MRI', '2026-08-03', 1, 'Κηφισιά', 'PAM01', 'ΠΑΜΜΑΚΑΡΙΣΤΟΣ', NULL, NULL, NULL, NULL),

-- 7. Pamakristos General On-Call Auto-Assignment (Ward Pamakristos)
(1006, 5005, 'ΧΡΗΣΤΟΣ', 'ΓΕΩΡΓΙΑΔΗΣ', 22140, 'ΑΞΟΝΙΚΗ ΤΟΜΟΓΡΑΦΙΑ ΘΩΡΑΚΑ', 'CT', '2026-08-03', 1, 'Κηφισιά', 'PAM01', 'ΠΑΜΜΑΚΑΡΙΣΤΟΣ', NULL, NULL, NULL, NULL),

-- 8. Constraint Comment Exclusion "ΟΧΙ ΑΛΕΞΙΟΥ" (Rule Engine Exclusion Demo)
(1007, 5006, 'ΑΝΑΣΤΑΣΙΑ', 'ΣΤΑΜΑΤΙΟΥ', 22150, 'ΜΑΓΝΗΤΙΚΗ ΤΟΜΟΓΡΑΦΙΑ ΕΓΚΕΦΑΛΟΥ', 'MRI', '2026-08-03', 1, 'Κηφισιά', 'DOC104', 'ΔΡ. ΝΙΚΟΛΑΟΥ ΕΛΕΝΗ', NULL, 'ΠΡΟΣΟΧΗ: ΟΧΙ ΑΛΕΞΙΟΥ', NULL, NULL),

-- 9. General Clinical Comment WITHOUT Diagnostician Name (Standard comment display)
(1011, 5007, 'ΕΛΕΝΗ', 'ΚΑΡΑΛΗ', 22140, 'ΑΞΟΝΙΚΗ ΤΟΜΟΓΡΑΦΙΑ ΘΩΡΑΚΑ', 'CT', '2026-08-03', 1, 'Κηφισιά', 'DOC104', 'ΔΡ. ΝΙΚΟΛΑΟΥ ΕΛΕΝΗ', NULL, 'ΠΡΟΣΟΧΗ: ΕΠΕΙΓΟΝ - ΑΣΘΕΝΗΣ ΜΕ ΣΚΙΑΓΡΑΦΙΚΟ IV', NULL, NULL),

-- 10. General Clinical Comment WITHOUT Diagnostician Name (Comparison note)
(1012, 5008, 'ΜΙΧΑΗΛ', 'ΠΑΠΑΔΑΚΗΣ', 22150, 'ΜΑΓΝΗΤΙΚΗ ΤΟΜΟΓΡΑΦΙΑ ΕΓΚΕΦΑΛΟΥ', 'MRI', '2026-08-03', 2, 'Αμπελόκηποι', 'DOC103', 'ΔΡ. ΑΝΤΩΝΙΟΥ ΑΝΔΡΕΑΣ', NULL, 'ΣΥΓΚΡΙΣΗ ΜΕ ΠΡΟΗΓΟΥΜΕΝΗ ΕΞΕΤΑΣΗ ΑΠΟ 15/05/2026 - ΘΑ ΣΤΑΛΕΙ ΜΕ EMAIL', NULL, NULL),

-- 11. Patient History Match (oldpers=3 ΓΕΩΡΓΙΑΔΟΥ ΓΕΩΡΓΙΑ — Skilled & Available)
(1013, 5009, 'ΔΗΜΗΤΡΑ', 'ΣΠΑΝΟΥ', 22150, 'ΜΑΓΝΗΤΙΚΗ ΤΟΜΟΓΡΑΦΙΑ ΕΓΚΕΦΑΛΟΥ', 'MRI', '2026-08-03', 2, 'Αμπελόκηποι', 'DOC104', 'ΔΡ. ΝΙΚΟΛΑΟΥ ΕΛΕΝΗ', NULL, 'ΕΠΑΝΕΛΕΓΧΟΣ ΜΕΤΑ ΑΠΟ 6 ΜΗΝΕΣ', 3, 'ΓΕΩΡΓΙΑΔΟΥ'),

-- 12. Patient History Match (oldpers=1 ΑΛΕΞΙΟΥ ΑΛΕΞΑΝΔΡΟΣ — Skilled & Available)
(1014, 5010, 'ΑΘΑΝΑΣΙΟΣ', 'ΦΩΤΙΟΥ', 22140, 'ΑΞΟΝΙΚΗ ΤΟΜΟΓΡΑΦΙΑ ΘΩΡΑΚΑ', 'CT', '2026-08-03', 1, 'Κηφισιά', 'DOC103', 'ΔΡ. ΑΝΤΩΝΙΟΥ ΑΝΔΡΕΑΣ', NULL, 'ΕΠΑΝΕΛΕΓΧΟΣ CT ΘΩΡΑΚΑ', 1, 'ΑΛΕΞΙΟΥ'),

-- 13. Non-Exclusive Preferred Doctor Partnership (Doctor DOC102 -> Diagnostician 3 Γεωργιάδου)
(1015, 5011, 'ΣΟΦΙΑ', 'ΚΩΝΣΤΑΝΤΙΝΙΔΟΥ', 22150, 'ΜΑΓΝΗΤΙΚΗ ΤΟΜΟΓΡΑΦΙΑ ΕΓΚΕΦΑΛΟΥ', 'MRI', '2026-08-03', 2, 'Αμπελόκηποι', 'DOC102', 'ΔΡ. ΘΕΟΔΩΡΟΥ ΣΟΦΙΑ', NULL, NULL, NULL, NULL),

-- 14. Dynamic Lab Routing Rule (Lab 2 MRI Spine -> Diagnostician 5 Ευαγγελάτος)
(1016, 5012, 'ΚΩΝΣΤΑΝΤΙΝΟΣ', 'ΡΑΠΤΗΣ', 22151, 'ΜΑΓΝΗΤΙΚΗ ΤΟΜΟΓΡΑΦΙΑ ΣΠΟΝΔΥΛΙΚΗΣ ΣΤΗΛΗΣ', 'MRI', '2026-08-03', 2, 'Αμπελόκηποι', 'DOC103', 'ΔΡ. ΑΝΤΩΝΙΟΥ ΑΝΔΡΕΑΣ', NULL, NULL, NULL, NULL),

-- 15. Additional CT Abdomen
(1009, 5013, 'ΑΙΚΑΤΕΡΙΝΗ', 'ΜΑΚΡΗ', 22141, 'ΑΞΟΝΙΚΗ ΤΟΜΟΓΡΑΦΙΑ ΚΟΙΛΙΑΣ', 'CT', '2026-08-02', 1, 'Κηφισιά', 'DOC103', 'ΔΡ. ΑΝΤΩΝΙΟΥ ΑΝΔΡΕΑΣ', NULL, NULL, NULL, NULL),

-- 16. Additional MRI Brain
(1010, 5014, 'ΣΠΥΡΙΔΩΝ', 'ΑΛΕΞΙΟΥ', 22150, 'ΜΑΓΝΗΤΙΚΗ ΤΟΜΟΓΡΑΦΙΑ ΕΓΚΕΦΑΛΟΥ', 'MRI', '2026-08-02', 2, 'Αμπελόκηποι', 'DOC104', 'ΔΡ. ΝΙΚΟΛΑΟΥ ΕΛΕΝΗ', NULL, NULL, NULL, NULL),

-- Already Assigned / Synced Exams (Capacity & History Demo with Order Grouping)
(2001, 6001, 'ΕΥΑΓΓΕΛΙΑ', 'ΔΗΜΟΥ', 22140, 'ΑΞΟΝΙΚΗ ΤΟΜΟΓΡΑΦΙΑ ΘΩΡΑΚΑ', 'CT', '2026-08-03', 1, 'Κηφισιά', 'DOC103', 'ΔΡ. ΑΝΤΩΝΙΟΥ ΑΝΔΡΕΑΣ', 1, NULL, NULL, NULL),
(2002, 6002, 'ΝΙΚΟΛΑΟΣ', 'ΚΑΡΑΓΙΑΝΝΗΣ', 22150, 'ΜΑΓΝΗΤΙΚΗ ΤΟΜΟΓΡΑΦΙΑ ΕΓΚΕΦΑΛΟΥ', 'MRI', '2026-08-03', 2, 'Αμπελόκηποι', 'DOC104', 'ΔΡ. ΝΙΚΟΛΑΟΥ ΕΛΕΝΗ', 2, NULL, NULL, NULL),
(2004, 6002, 'ΝΙΚΟΛΑΟΣ', 'ΚΑΡΑΓΙΑΝΝΗΣ', 22151, 'ΜΑΓΝΗΤΙΚΗ ΤΟΜΟΓΡΑΦΙΑ ΣΠΟΝΔΥΛΙΚΗΣ ΣΤΗΛΗΣ', 'MRI', '2026-08-03', 2, 'Αμπελόκηποι', 'DOC104', 'ΔΡ. ΝΙΚΟΛΑΟΥ ΕΛΕΝΗ', 2, NULL, NULL, NULL),
(2003, 6003, 'ΜΑΡΙΝΑ', 'ΡΑΠΤΗ', 22151, 'ΜΑΓΝΗΤΙΚΗ ΤΟΜΟΓΡΑΦΙΑ ΣΠΟΝΔΥΛΙΚΗΣ ΣΤΗΛΗΣ', 'MRI', '2026-08-03', 2, 'Αμπελόκηποι', 'DOC102', 'ΔΡ. ΘΕΟΔΩΡΟΥ ΣΟΦΙΑ', 5, NULL, NULL, NULL);
