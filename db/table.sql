...
EXEC getExamsListForPeriod_V1 '2026-07-29','2026-07-31'
	OLDEXAM	OLDVISIT	OLDORDER	OLDPERS	OLDDIAGNOSTIS	AA	EXTRACODE	VISITID	DEMOGID	FNAME	LNAME	AGE	EXAMID	EXAMNUMCODE	EXAMNAME	VISITDATE	LABCODEID	LABORATORYNAME	WARDID	WCODE	WNAME	DIAGNOSTIS	PERSONELID	CODE	NAME	NOTES	EXAMMOREID	CATEGORY

EXEC getdiagnosticsList
	personelid , docname
