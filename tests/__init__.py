...
def sample_candidates() -> list[CandidateDiagnostician]:
    ...
    return [
        ...
        CandidateDiagnostician(
            ...
            name="Λιάκος Δ.",
            can_ct=True,
            can_mri=False,  # CT only — should be filtered for MRI exams
            is_available=True,
            daily_quota=10,
            current_day_count=4,
            accepts_lab=False,  # Doesn't accept this lab
        ),
        CandidateDiagnostician(
            id=5,
            name="Αντωνίου Ζ.",
