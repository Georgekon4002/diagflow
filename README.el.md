...
| 🖥️ **Dashboard Γραμματείας** | **Διεπαφή Καρτελών Αναθεώρησης** | Dashboard με καρτέλες εκκρεμών/ανατεθέντων, άμεση δημιουργία προτάσεων, ανάλυση κανόνων και ομαδικές ενέργειες. |
| 🔐 **Admin Panel** | **Διαχείριση Ρυθμίσεων** | Πιστοποιημένη διεπαφή για διαχείριση διαγνωστών, εξειδικεύσεων, συνεργασιών, κανόνων δρομολόγησης και βαρών βαθμολόγησης. |
...
|-----------|--------|-----------|-----------|
| **Συνεργασία Γιατρού** | `pts_partnership` | `0.35` | Προτιμώμενος διαγνωστής για τον εκδίδοντα γιατρό |
| **Ιστορικό Ασθενή** | `pts_history` | `0.20` | Συνέχεια φροντίδας |
...
- **Καρτέλα Εκκρεμών:** Πίνακας εξετάσεων, δημιουργία πρότασης, tooltips βαθμολογίας, παράθυρο εναλλακτικών, ομαδικές ενέργειες.
- **Καρτέλα Ανατεθέντων:** Εκκρεμείς ωθήσεις στο Slis, ετικέτες κανόνων, αυτόματη σήμανση, συγχρονισμός.
